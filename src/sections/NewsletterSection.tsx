...
// import { submitNewsletter } from '@/lib/supabase' // Import your Supabase helper
...
//         setApiError(null)
//         try {
//             // Write to Supabase (automatically handles local fallback if unconfigured)
...
//         >
//             <div
//                 className="rounded-3xl p-12 md:p-16 text-center relative overflow-hidden mx-auto"
//                 style={{
//                     background: 'linear-gradient(135deg, rgba(245,245,247,0.9), rgba(245,245,247,0.75))',
//                     border: '1px solid rgba(0,0,0,0.08)',
//                     backdropFilter: 'blur(20px)',
//                     boxShadow: '0 8px 32px rgba(0,0,0,0.06)',
//                     maxWidth: '700px', // Exact mockup width
//                     marginLeft: '550px',
//                 }}
//             >
...
//                                 {errors.email && (
//                                     <p style={{ color: 'rgba(220,20,20,0.8)', fontSize: '12px', marginBottom: 0 }}>
