...
export default function RegistrationCard() {
  ...
  const {
    ...
    defaultValues: {
      registrationType: undefined, // Forces user to pick
    }
  })
  ...
  const onSubmit = async (data: RegistrationFormData) => {
    ...
    try {
        ...
        .insert([
          {
            ...
            participation_type: data.registrationType,
      ...
      console.warn("Supabase database insert failed, falling back to LocalStorage:", error)

      // LocalStorage Fallback (keeps the UI functional during local testing or database sync)
      if (typeof window !== 'undefined') {
        const existing = localStorage.getItem("nari_summit_registrations")
        const list = existing ? JSON.parse(existing) : []
        list.push({
          ...data,
          created_at: new Date().toISOString()
        })
        localStorage.setItem("nari_summit_registrations", JSON.stringify(list))
      }
